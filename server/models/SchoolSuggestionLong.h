...
class SchoolSuggestionLong
{
  public:
     ...
     */
    explicit SchoolSuggestionLong(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit SchoolSuggestionLong(const Json::Value &pJson) noexcept(false);
     ...
     */
    SchoolSuggestionLong(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    SchoolSuggestionLong() = default;
  ...
  private:
    friend drogon::orm::Mapper<SchoolSuggestionLong>;
    friend drogon::orm::BaseBuilder<SchoolSuggestionLong, true, true>;
    friend drogon::orm::BaseBuilder<SchoolSuggestionLong, true, false>;
    friend drogon::orm::BaseBuilder<SchoolSuggestionLong, false, true>;
    friend drogon::orm::BaseBuilder<SchoolSuggestionLong, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<SchoolSuggestionLong>;
#endif
