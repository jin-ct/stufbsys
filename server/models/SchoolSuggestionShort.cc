/**
 *
 *  SchoolSuggestionShort.cc
 *  DO NOT EDIT. This file is generated by drogon_ctl
 *
 */

#include "SchoolSuggestionShort.h"
...
const std::string SchoolSuggestionShort::Cols::_sch_sug_id = "\"sch_sug_id\"";
const std::string SchoolSuggestionShort::Cols::_title = "\"title\"";
const std::string SchoolSuggestionShort::Cols::_content = "\"content\"";
const std::string SchoolSuggestionShort::Cols::_is_public = "\"is_public\"";
const std::string SchoolSuggestionShort::Cols::_is_anonymous = "\"is_anonymous\"";
const std::string SchoolSuggestionShort::Cols::_name = "\"name\"";
const std::string SchoolSuggestionShort::Cols::_class = "\"class\"";
const std::string SchoolSuggestionShort::Cols::_grade = "\"grade\"";
const std::string SchoolSuggestionShort::Cols::_ai_score = "\"ai_score\"";
const std::string SchoolSuggestionShort::Cols::_type = "\"type\"";
const std::string SchoolSuggestionShort::Cols::_vote_count = "\"vote_count\"";
const std::string SchoolSuggestionShort::Cols::_date = "\"date\"";
const std::string SchoolSuggestionShort::primaryKeyName = "sch_sug_id";
const bool SchoolSuggestionShort::hasPrimaryKey = true;
const std::string SchoolSuggestionShort::tableName = "\"school_suggestion_short\"";

const std::vector<typename SchoolSuggestionShort::MetaData> SchoolSuggestionShort::metaData_={
{"sch_sug_id","int64_t","bigint",8,1,1,1},
{"title","std::string","character varying",255,0,0,1},
{"content","std::string","character varying",400,0,0,1},
...
const std::string &SchoolSuggestionShort::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
SchoolSuggestionShort::SchoolSuggestionShort(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
...
SchoolSuggestionShort::SchoolSuggestionShort(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
SchoolSuggestionShort::SchoolSuggestionShort(const Json::Value &pJson) noexcept(false)
{
...
void SchoolSuggestionShort::updateByMasqueradedJson(const Json::Value &pJson,
...
void SchoolSuggestionShort::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("sch_sug_id"))
    {
        if(!pJson["sch_sug_id"].isNull())
...
const int64_t &SchoolSuggestionShort::getValueOfSchSugId() const noexcept
{
...
const std::shared_ptr<int64_t> &SchoolSuggestionShort::getSchSugId() const noexcept
{
    return schSugId_;
}
void SchoolSuggestionShort::setSchSugId(const int64_t &pSchSugId) noexcept
{
    schSugId_ = std::make_shared<int64_t>(pSchSugId);
    dirtyFlag_[0] = true;
}
const typename SchoolSuggestionShort::PrimaryKeyType & SchoolSuggestionShort::getPrimaryKey() const
{
    assert(schSugId_);
    return *schSugId_;
}

const std::string &SchoolSuggestionShort::getValueOfTitle() const noexcept
{
...
const std::shared_ptr<std::string> &SchoolSuggestionShort::getTitle() const noexcept
{
    return title_;
}
void SchoolSuggestionShort::setTitle(const std::string &pTitle) noexcept
{
    title_ = std::make_shared<std::string>(pTitle);
    dirtyFlag_[1] = true;
}
void SchoolSuggestionShort::setTitle(std::string &&pTitle) noexcept
{
    title_ = std::make_shared<std::string>(std::move(pTitle));
    dirtyFlag_[1] = true;
}

const std::string &SchoolSuggestionShort::getValueOfContent() const noexcept
{
    static const std::string defaultValue = std::string();
    if(content_)
        return *content_;
...
const std::shared_ptr<std::string> &SchoolSuggestionShort::getContent() const noexcept
{
    return content_;
}
void SchoolSuggestionShort::setContent(const std::string &pContent) noexcept
{
    content_ = std::make_shared<std::string>(pContent);
    dirtyFlag_[2] = true;
}
void SchoolSuggestionShort::setContent(std::string &&pContent) noexcept
{
    content_ = std::make_shared<std::string>(std::move(pContent));
    dirtyFlag_[2] = true;
}

const bool &SchoolSuggestionShort::getValueOfIsPublic() const noexcept
{
...
const std::shared_ptr<bool> &SchoolSuggestionShort::getIsPublic() const noexcept
{
    return isPublic_;
}
void SchoolSuggestionShort::setIsPublic(const bool &pIsPublic) noexcept
{
    isPublic_ = std::make_shared<bool>(pIsPublic);
    dirtyFlag_[3] = true;
}

const bool &SchoolSuggestionShort::getValueOfIsAnonymous() const noexcept
{
    static const bool defaultValue = bool();
    if(isAnonymous_)
        return *isAnonymous_;
...
const std::shared_ptr<bool> &SchoolSuggestionShort::getIsAnonymous() const noexcept
{
    return isAnonymous_;
}
void SchoolSuggestionShort::setIsAnonymous(const bool &pIsAnonymous) noexcept
{
    isAnonymous_ = std::make_shared<bool>(pIsAnonymous);
    dirtyFlag_[4] = true;
}

const std::string &SchoolSuggestionShort::getValueOfName() const noexcept
{
    static const std::string defaultValue = std::string();
    if(name_)
        return *name_;
...
const std::shared_ptr<std::string> &SchoolSuggestionShort::getName() const noexcept
{
    return name_;
}
void SchoolSuggestionShort::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[5] = true;
}
void SchoolSuggestionShort::setName(std::string &&pName) noexcept
{
    name_ = std::make_shared<std::string>(std::move(pName));
    dirtyFlag_[5] = true;
}
void SchoolSuggestionShort::setNameToNull() noexcept
{
    name_.reset();
    dirtyFlag_[5] = true;
}

const std::string &SchoolSuggestionShort::getValueOfClass() const noexcept
{
    static const std::string defaultValue = std::string();
    if(class_)
        return *class_;
...
const std::shared_ptr<std::string> &SchoolSuggestionShort::getClass() const noexcept
{
    return class_;
}
void SchoolSuggestionShort::setClass(const std::string &pClass) noexcept
{
    class_ = std::make_shared<std::string>(pClass);
    dirtyFlag_[6] = true;
}
void SchoolSuggestionShort::setClass(std::string &&pClass) noexcept
{
    class_ = std::make_shared<std::string>(std::move(pClass));
    dirtyFlag_[6] = true;
}
void SchoolSuggestionShort::setClassToNull() noexcept
{
    class_.reset();
    dirtyFlag_[6] = true;
}

const std::string &SchoolSuggestionShort::getValueOfGrade() const noexcept
{
    static const std::string defaultValue = std::string();
    if(grade_)
        return *grade_;
...
const std::shared_ptr<std::string> &SchoolSuggestionShort::getGrade() const noexcept
{
    return grade_;
}
void SchoolSuggestionShort::setGrade(const std::string &pGrade) noexcept
{
    grade_ = std::make_shared<std::string>(pGrade);
    dirtyFlag_[7] = true;
}
void SchoolSuggestionShort::setGrade(std::string &&pGrade) noexcept
{
    grade_ = std::make_shared<std::string>(std::move(pGrade));
    dirtyFlag_[7] = true;
}
void SchoolSuggestionShort::setGradeToNull() noexcept
{
    grade_.reset();
    dirtyFlag_[7] = true;
}

const float &SchoolSuggestionShort::getValueOfAiScore() const noexcept
{
...
const std::shared_ptr<float> &SchoolSuggestionShort::getAiScore() const noexcept
{
    return aiScore_;
}
void SchoolSuggestionShort::setAiScore(const float &pAiScore) noexcept
{
    aiScore_ = std::make_shared<float>(pAiScore);
    dirtyFlag_[8] = true;
}
void SchoolSuggestionShort::setAiScoreToNull() noexcept
{
    aiScore_.reset();
    dirtyFlag_[8] = true;
}

const short &SchoolSuggestionShort::getValueOfType() const noexcept
{
...
const std::shared_ptr<short> &SchoolSuggestionShort::getType() const noexcept
{
    return type_;
}
void SchoolSuggestionShort::setType(const short &pType) noexcept
{
    type_ = std::make_shared<short>(pType);
    dirtyFlag_[9] = true;
}

const int32_t &SchoolSuggestionShort::getValueOfVoteCount() const noexcept
{
...
const std::shared_ptr<int32_t> &SchoolSuggestionShort::getVoteCount() const noexcept
{
    return voteCount_;
}
void SchoolSuggestionShort::setVoteCount(const int32_t &pVoteCount) noexcept
{
    voteCount_ = std::make_shared<int32_t>(pVoteCount);
    dirtyFlag_[10] = true;
}
void SchoolSuggestionShort::setVoteCountToNull() noexcept
{
    voteCount_.reset();
    dirtyFlag_[10] = true;
}

const ::trantor::Date &SchoolSuggestionShort::getValueOfDate() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &SchoolSuggestionShort::getDate() const noexcept
{
    return date_;
}
void SchoolSuggestionShort::setDate(const ::trantor::Date &pDate) noexcept
{
    date_ = std::make_shared<::trantor::Date>(pDate.roundDay());
    dirtyFlag_[11] = true;
}

void SchoolSuggestionShort::updateId(const uint64_t id)
{
}

const std::vector<std::string> &SchoolSuggestionShort::insertColumns() noexcept
{
...
void SchoolSuggestionShort::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getTitle())
...
const std::vector<std::string> SchoolSuggestionShort::updateColumns() const
{
...
void SchoolSuggestionShort::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getTitle())
...
Json::Value SchoolSuggestionShort::toJson() const
{
    Json::Value ret;
    if(getSchSugId())
    {
...
Json::Value SchoolSuggestionShort::toMasqueradedJson(
...
bool SchoolSuggestionShort::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("sch_sug_id"))
    {
...
bool SchoolSuggestionShort::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool SchoolSuggestionShort::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("sch_sug_id"))
    {
...
bool SchoolSuggestionShort::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                             const std::vector<std::string> &pMasqueradingVector,
                                                             std::string &err)
{
    if(pMasqueradingVector.size() != 12)
...
bool SchoolSuggestionShort::validJsonOfField(size_t index,
                                             ...
                                             bool isForCreation)
{
    switch(index)
    {
        ...
        case 2:
            ...
            if(pJson.isString() && std::strlen(pJson.asCString()) > 400)
            {
                err="String length exceeds limit for the " +
                    fieldName +
                    " field (the maximum value is 400)";
                return false;
            }
