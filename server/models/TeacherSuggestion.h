...
class TeacherSuggestion
{
  public:
    struct Cols
    {
        static const std::string _tch_sug_id;
     ...
     */
    explicit TeacherSuggestion(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit TeacherSuggestion(const Json::Value &pJson) noexcept(false);
     ...
     */
    TeacherSuggestion(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    TeacherSuggestion() = default;
    ...
    /**  For column tch_sug_id  */
    ///Get the value of the column tch_sug_id, returns the default value if the column is null
    const int64_t &getValueOfTchSugId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getTchSugId() const noexcept;
    ///Set the value of the column tch_sug_id
    void setTchSugId(const int64_t &pTchSugId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<TeacherSuggestion>;
    friend drogon::orm::BaseBuilder<TeacherSuggestion, true, true>;
    friend drogon::orm::BaseBuilder<TeacherSuggestion, true, false>;
    friend drogon::orm::BaseBuilder<TeacherSuggestion, false, true>;
    friend drogon::orm::BaseBuilder<TeacherSuggestion, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<TeacherSuggestion>;
#endif
    ...
    std::shared_ptr<int64_t> tchSugId_;
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where tch_sug_id = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where tch_sug_id = $1";
        return sql;
    }
