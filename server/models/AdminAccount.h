...
class AdminAccount
{
  public:
     ...
     */
    explicit AdminAccount(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AdminAccount(const Json::Value &pJson) noexcept(false);
     ...
     */
    AdminAccount(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const int32_t &getValueOfAdminId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getAdminId() const noexcept;
    ///Set the value of the column admin_id
    void setAdminId(const int32_t &pAdminId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<AdminAccount>;
    friend drogon::orm::BaseBuilder<AdminAccount, true, true>;
    friend drogon::orm::BaseBuilder<AdminAccount, true, false>;
    friend drogon::orm::BaseBuilder<AdminAccount, false, true>;
    friend drogon::orm::BaseBuilder<AdminAccount, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<AdminAccount>;
#endif
    ...
    std::shared_ptr<int32_t> adminId_;
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where admin_id = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where admin_id = $1";
        return sql;
    }
