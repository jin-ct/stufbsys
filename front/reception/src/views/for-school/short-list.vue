<template>
  <div class="main-container">
    ...
    <Dialog v-model="addItemVisible" title="写建议">
      <addSuggestion v-model:is-loading="isAddSubmitLoading" @submit="handleAddSubmit" />
    </Dialog>
  </div>
</template>
...
import { useSchSuggestionShort } from '@/hooks/useSchSuggestionShort';
